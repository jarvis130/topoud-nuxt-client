        ...
        uploaderModule(@upload='upload_1' :size='[375, 180]')
            .homepage-module-panel.image-panel(ref='videoContainer')
                ...
                .loading(v-if='content[0]._picUrl && !content[0].picUrl') 上传中，请稍后
                    .weui-loading
                video(:poster='content[0].picUrl ? content[0].picUrl + "?vframe/jpg/offset/0" : ""' style='width:100%' ref='video' v-if='content[0]._picUrl || content[0].picUrl' :src='content[0].picUrl || content[0]._picUrl' controls="controls" )
